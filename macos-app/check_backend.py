...
FILES = ('vx_process.py', 'vx_runtime.py', 'vx.py', 'vx_link.py', 'vx_tiktok.py', 'vx_wxchannels.py', 'vx_browser_cookie.py','vx_kuaishou.py', 'vendor/wxdecrypt/main.go', 'vendor/wxdecrypt/decrypt.go', 'vendor/wxdecrypt/LICENSE', 'vendor/wxdecrypt/NOTICE.md')
